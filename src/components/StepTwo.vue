    ...
    <v-row justify="center" class="mt-15 pt-15">
      <v-col cols="12" class="text-center">
        <h3 style="font-family: Orbitron">
          Are you able to move around in your current environment?
        </h3>
      </v-col>
      <v-col
        cols="12"
        class="text-center"
        v-for="l in location_types"
        :key="l.value"
      >
        <v-btn
          flat
          ...
          rounded
          :class="
            user_store.selections.move_vs_static == l.value ? '' : 'border'
          "
          :color="
            user_store.selections.move_vs_static == l.value ? 'primary' : null
          "
