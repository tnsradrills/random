    ...
    <v-row justify="center" class="mt-15 pt-15">
      <v-col cols="12" class="text-center pb-3">
        <h3 style="font-family: Orbitron">
          Select some drill categories to include (minimum of 2):
        </h3>
      </v-col>
      <v-col
        cols="12"
        class="text-center py-1"
        v-for="l in category_list"
        :key="l.value"
      >
        <v-btn
          flat
          ...
          rounded
          :class="
            user_store.selections.category_selections.includes(l.value)
              ? ''
              : 'border'
          "
          :color="
